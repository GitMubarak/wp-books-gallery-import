...
if ( isset( $_POST['saveImportSettings'] ) ) {
...
<div id="wph-wrap-all" class="wrap wbg-settings-page">
    ...
    <div class="wbg-wrap" style="width: 100%; border: 0px solid #000;">
        ...
        <div class="wbg_personal_wrap wbg_personal_help" style="width: 75%; float: left;">
            ...
            <table class="wbg-general-settings-table">
                <tr>
                    <th scope="row">
                        ...
                        <br>
                        <code><?php _e('Only CSV file is permitted.', WBGI_TXT_DOMAIN); ?></code>
                    </th>
                    <td>
            ...
            <p class="submit"><button id="saveImportSettings" name="saveImportSettings"
                    class="button button-primary wbg-button"><?php _e('Import Books', WBGI_TXT_DOMAIN); ?></button></p>
            </form>
